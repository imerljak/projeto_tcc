                                                ...
                                                <div class="pull-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right" role="menu">
                                                            <li><a href="${TIPO_DOCUMENTO.id}"><i class="fa fa-level-up fa-fw"></i>  View</a></li>
                                                            <li><a href="${appPath}/tipoDocumento/update/${TIPO_DOCUMENTO.id}"><i class="fa fa-edit fa-fw"></i>  Edit</a></li>
                                                            <li class="divider"></li>
                                                            <li><a data-toggle="modal" data-target="#confirm_delete_${TIPO_DOCUMENTO.id}" href="#"  ><i class="fa fa-trash-o fa-fw"></i> Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <!-- Modal -->
                                                <div class="modal fade" id="confirm_delete_${TIPO_DOCUMENTO.id}" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="${appPath}/tipoDocumento/remove/${TIPO_DOCUMENTO.id}" method="DELETE">
